...
export default function Index() {
    ...
    <section data-aos="fade-up" data-aos-delay="600" id="home" className="min-h-screen flex items-center pt-16">
      <div className="container mx-auto px-6 py-12">
        <h1 className="text-4xl md:text-5xl font-bold mb-4">Welcome to my Portofolio! ^_^</h1>
        <p className="text-xl mb-2 text-slate-300">Hello! I'm <span className="text-sky-600 font-bold">Luthfi Aditya</span>,</p>
        <p className="text-xl mb-6 text-slate-300">a <span className="text-sky-600 font-bold">Web Developer</span>, and <span className="text-sky-600 font-bold">Mobile Developer</span> that focusing on Interactive, Responive, and Web and Multiplatform  Mobile Application Development.</p>
        <Link to={Route.about} className="hero-btn text-white font-semibold py-3 px-6 rounded-lg transition duration-300 inline-block mt-4">Let's know about me more!</Link><br /><span className="text-slate-300">or</span><br /><a href="src/Curriculum Vitae_Luthfi Aditya.pdf" target="_blank" className="hero-btn text-white font-semibold py-3 px-6 rounded-lg transition duration-300 inline-block mt-4">Have a look at my CV! 👀</a>
      </div>
    </section>
    ...
    <div className="flex flex-wrap">
      ...
      <section id="skills" data-aos="fade-up" data-aos-delay="700" className="w-full md:w-1/2 py-16 px-6">
        <h2 data-aos="fade-up" className="section-title text-3xl font-bold mb-12 text-center">Keahlian Teknis</h2>
        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-2 gap-6">
          {/* <!-- HTML Skill --> */}
          <div data-aos="fade-up" data-aos-delay="500">
            <div className="skill-card p-6 shadow-md transition-all duration-300 ease-linear text-center">
              <i className="fab fa-html5 text-5xl mb-4" style={{ color: "#e34c26" }} />
          ...
          <div data-aos="fade-up" data-aos-delay="700">
            <div className="skill-card p-6 shadow-md transition duration-300 text-center">
              <i className="fab fa-css3-alt text-5xl mb-4" style={{color: "#264de4"}}></i>
          ...
          <div data-aos="fade-up" data-aos-delay="500">
            <div className="skill-card p-6 shadow-md transition duration-300 text-center">
              <i className="fab fa-css3 text-5xl mb-4" style={{color: "#38bdf8"}}></i>
          ...
          <div data-aos="fade-up" data-aos-delay="700">
            <div className="skill-card p-6 shadow-md transition duration-300 text-center">
              <i className="fab fa-git-alt text-5xl mb-4" style={{color: "#f34f29"}}></i>
          ...
          <div data-aos="fade-up" data-aos-delay="500">
            <div className="skill-card p-6 shadow-md transition duration-300 text-center">
              <i className="fas fa-database text-5xl mb-4" style={{color: "#336791"}}></i>
          ...
          <div data-aos="fade-up" data-aos-delay="700">
            <div className="skill-card p-6 shadow-md transition duration-300 text-center">
              <i className="fab fa-node-js text-5xl mb-4" style={{color: "#3c873a"}}></i>
          ...
          <div data-aos="fade-up" data-aos-delay="500">
            <div className="skill-card p-6 shadow-md transition duration-300 text-center">
              <i className="fab fa-android text-5xl mb-4" style={{color: "#3c873a"}}></i>
          ...
          <div data-aos="fade-up" data-aos-delay="700">
            <div className="skill-card p-6 shadow-md transition duration-300 text-center">
              <i className="fab fa-laravel text-5xl mb-4" style={{color: "#ff2d20"}}></i>
          ...
          <div data-aos="fade-up" data-aos-delay="500">
            <div className="skill-card p-6 shadow-md transition duration-300 text-center">
              <i className="fab fa-flutter fa-bounce text-5xl mb-4" style={{color: "#74c0fc"}}></i>
          ...
          <div data-aos="fade-up" data-aos-delay="700">
            <div className="skill-card p-6 shadow-md transition duration-300 text-center">
              <i className="fab fa-google text-5xl mb-4" style={{color: "#ff0000"}}></i>
    ...
    <section id="projects" data-aos="fade-up" data-aos-delay="400" className="py-16 glassmorphism-section">
      <div className="container mx-auto px-6">
        <h2 className="section-title text-3xl font-bold mb-12 text-center">Latest Project</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div data-aos="fade-up" data-aos-mobile="fade-right" data-aos-delay="500">
            <div className="project-card rounded-lg overflow-hidden shadow-md transition duration-300">
              <div className="image-container w-full h-48">
                <img src="/api/placeholder/400/320" alt="Proyek 1" className="w-full h-full object-cover" />
              </div>
              <div className="p-6">
                ...
                <a href="https://youtu.be/1yEdsNHTWZo?si=m5_UfoDv10J0-0sW" className="project-btn inline-block font-medium py-2 px-4 rounded transition duration-300">Lihat Proyek</a>
              </div>
            </div>
          </div>
          ...
          <div data-aos="fade-up" data-aos-mobile="fade-right" data-aos-delay="500">
            <div className="project-card rounded-lg overflow-hidden shadow-md transition duration-300">
              <div className="image-container w-full h-48">
                <img src="/api/placeholder/400/320" alt="Proyek 2" className="w-full h-full object-cover" />
              </div>
              <div className="p-6">
                ...
                <a href="https://github.com/rofiframadhanks/esr" className="project-btn inline-block font-medium py-2 px-4 rounded transition duration-300">Lihat Proyek</a>
              </div>
            </div>
          </div>
          ...
          <div data-aos="fade-up" data-aos-mobile="fade-right" data-aos-delay="500">
            <div className="project-card rounded-lg overflow-hidden shadow-md transition duration-300">
              <div className="image-container w-full h-48">
                <img src="/api/placeholder/400/320" alt="Proyek 3" className="w-full h-full object-cover" />
              </div>
              <div className="p-6">
                ...
                <a href="https://github.com/LuthfiAditya01/SIP-SJ" className="project-btn inline-block font-medium py-2 px-4 rounded transition duration-300">Lihat Proyek</a>
              </div>
            </div>
          </div>
        </div>
